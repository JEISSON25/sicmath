...
if(isset($_SESSION['id'])){  
    ...
    $query = pg_query ($conexion, "select * from niveles where id='".$id."' ");
          ...
          <div class="col-lg-12 col-12">
            <!-- small box -->
              ...
              <div class="card-header">
                ...
                <h3 class="card-title"><?php if($_GET['modo']==1){ ?> EDITAR <?php }else if($_GET['modo']==2){?> ELIMINAR <?php } ?>    NIVEL</h3>
              </div>
              <div class="card-body">                               
                                    
                         
              <div class="input-group mb-3">
                        <input type="text" class="form-control" id='nivel' value="<?php echo $datos['descripcion'] ?>" placeholder="Nombre del nivel" required>
                        <div class="input-group-append">
                        ...
                        <div class="input-group mb-3">
                        <input type="text" class="form-control" id='min'  value="<?php echo $datos['min'] ?>"  placeholder="Mínimo puntaje" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                            <span class="fas fa-user"></span>
                            </div>
                        ...
                        <div class="input-group mb-3">
                        <input type="text" class="form-control" id='max'  value="<?php echo $datos['max'] ?>"   placeholder="Máximo puntaje" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                            <span class="fas fa-user"></span>
                            </div>
        ...
        $("#guardar").click(function(){
             ...
             var id= "<?php echo $id ?>";
                              ...
                              if(nivel!="" && min!="" && max!=""){
                                    ...
                                    var datos='g_colegio='+1+'&editar_nivel='+1+'&nivel='+nivel+'&min='+min+'&max='+max+'&id='+id;
                                     $.ajax({
                                       type: "POST",
                                       data: datos,
                                       ...
                                       success: function (valor){
                                            if(valor==1){
                                             ...
                                             alert ("El nombre del nivel ya se encuentra creado, intente con otro");
                ...
                $("#eliminar").click(function(){
                          ...
                          var id= "<?php echo $id ?>";
                                    ...
                                    var datos='g_colegio='+1+'&eliminar_nivel='+1+'&id='+id;
                                     $.ajax({
                                       type: "POST",
                                       data: datos,
                                       url: "../../app/modelos/funciones.php",
