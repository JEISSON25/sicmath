            ...
            <section class="content">
             <div class="container-fluid">
                ...
                <div class="col-lg-6 col-8">
                    ...
                    <a href="select_plantilla.php" class="small-box-footer">Hazme clic <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-6 col-8">
                    ...
                    <a href="mis_resultados.php" class="small-box-footer">Hazme clic <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                </section>  
