          ...
          <div class="col-lg-12 col-12">
            <!-- small box -->
              ...
              <div class="card-header">
                <h3 class="card-title">CREAR UN NIVEL</h3>
              </div>
              <div class="card-body">
                ...
                <form class="needs-validation">                          
                        ...
                        <input type="text" class="form-control" id='nivel'  placeholder="Nombre del nivel" required>
                        <div class="input-group-append">
                        ...
                        <div class="input-group mb-3">
                        <input type="text" class="form-control" id='min'  placeholder="Mínimo puntaje" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                            <span class="fas fa-user"></span>
                            </div>
                        ...
                        <div class="input-group mb-3">
                        <input type="text" class="form-control" id='max'  placeholder="Máximo puntaje" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                            <span class="fas fa-user"></span>
                            </div>
...
$(document).ready(function () {
        ...
        //var datos1='g_plantilla='+1+'&listar='+1;
         $('#table_id').DataTable({           
            ...
            stateSave: true,
            "ajax": {
                "url": "../../app/modelos/funciones.php?listar_nivel=1",
                "type": "POST"                
            },
            "columns": [
                ...
                $("#guardar").click(function(){
                          ...
                          var max = $("#max").val();  
                              ...
                              if(nivel!="" && min!="" && max!=""){
                                    ...
                                    var datos='g_colegio='+1+'&crea_nivel='+1+'&nivel='+nivel+'&min='+min+'&max='+max;
                                     $.ajax({
                                       type: "POST",
                                       data: datos,
